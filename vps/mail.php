...
$site_top = "//www.winserver.ne.jp/";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
//$to = "chidashuuichi@gmail.com";
$to = "support@winserver.ne.jp";

//自動返信メールの送信元メールアドレス
//必ず実在するメールアドレスでかつ出来る限り設置先サイトのドメインと同じドメインのメールアドレスとすることを強く推奨します
//$from = "chidashuuichi@gmail.com";
$from = "support@winserver.ne.jp";
...
$Referer_check_domain = "www.winserver.ne.jp";
...
$subject = "【Winserver－お問い合わせ】VPSについてお問い合わせがありました。";
...
$require = array('氏名','メールアドレス','問い合わせ内容');
...
$re_subject = "【Winserver】VPSについてお問い合わせいただきありがとうございます";
...
この度は、Winserverへお問い合わせいただき、
誠にありがとうございます。

お問い合わせの内容を確認の上、１営業日以内にご返信いたしますので、
...
＜新規お問い合わせ窓口＞
電話：0120-951-168
メール：info@winserver.ne.jp
営業時間：平日9:00～17:00（土日・祝祭日を除く）

アシストアップ株式会社
大阪市中央区久太郎町3-6-8 御堂筋ダイワビル8F
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
<meta name="description" content="月額900円から使えるWindows VPS｜WinserverのVPSは業界最高のコストパフォーマンス｜OSは最新のWindows Server 2019～2012の中から選択可能｜全プランSSDを搭載｜スケールアップ可｜充実の無料サポート">
<meta name="keywords" content="">


<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Barlow:ital,wght@0,500;0,700;1,400&family=Noto+Sans+JP:wght@500;700;900&display=swap">


<link rel="stylesheet" href="parts/css/reset.css" type="text/css">
<link rel="stylesheet" href="parts/css/style.css" type="text/css">

<title>お問い合わせ 確認画面｜Windows VPSならWindows専門のWinserver</title>
...
<header class="header">
	...
	<div class="pc2">
		<div class="inner">
		<div class="title-box">
				<h1 class="title">Windows VPSならWindows専門のWinserver</h1>
				<p class="logo"><a href="./"><img src="parts/img/logo_pc.png" alt=""></a></p>
			</div>
			<ul class="gnav">
				<li><a href="./#plan">料金プラン</a></li>
				<li><a href="./#character">特徴</a></li>
				<li><a href="./#compare">他社との比較</a></li>
				<li><a href="./#perform">基本性能</a></li>
	...
	<div class="sp2">
		<div class="inner">
			<h1 class="logo"><a href="./"><img src="parts/img/logo_sp.png" alt=""></a></h1>
			<p class="open"><img src="parts/img/menu_open.svg" alt="MENU" id="menu-btn"></p>
			<div id="menu-conts" class="fadein">
        <div class="accordion-menu theme-accordion">
          <p class="alone noimg"><a href="./#plan">料金プラン</a></p>
          <p class="alone noimg"><a href="./#compare">他社との比較</a></p>
          <p class="alone noimg"><a href="./#character">特徴</a></p>
          <p class="alone noimg"><a href="./#perform">基本性能</a></p>
          <p class="alone noimg"><a href="./#option">オプション</a></p>
					<p class="alone noimg"><a href="./#flow">お申込みの流れ</a></p>
					<p class="alone noimg"><a href="./#faq">よくある質問</a></p>
        </div>
			</div>
		</div>
	</div>
...
<section class="sec-contact">
  <div class="inner">
		<h2 class="sub-head"><span>お問い合わせフォーム</span>Contact</h2>
  </div>
</section>
...
<div align="center">
	<h3>入力にエラーがあります。</h3>
	<p>下記をご確認の上、入力画面へ戻り、修正をお願いいたします。</p>
	<div class="error"><?php echo $errm; ?></div>
...
<h1 class="certify_title">確認画面</h1>
<p class="certify_text">以下の内容で間違いがなければ、<br class="pcnone"><b>「送信する」</b>ボタンを押してください。</p>

<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">

<table class="formTable-certify">
...
<p class="certify-center">
	<input type="submit" value="送信する" class="btn-submit2">
	<input type="button" value="戻って修正する" class="btn-revise" onClick="history.back()">
</p>
...
<div class="inner">
	<!-- COPYRIGHT -->
	<p class="copyright">Copyright &copy; 2020 Winserver All rights reserved.</p>

	<!-- BACK TO TOP-->
	<div id="backToTop">
		<div class="inner">
			<span class="totop"><a href="#wrapper"><img src="parts/img/btn_totop_on.svg" alt=""></a></span>
		</div>
	</div>
...
<input type="button" value=" 戻って修正する " onClick="history.back()"></div>
<?php
